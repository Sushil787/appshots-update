...
export const AppearanceSection = ({
  ...
  <SidebarSection title="Appearance">
    <div className="space-y-4">
      ...
      {/* Text Color */}
      <div>
        <label className="block text-xs font-medium text-neutral-600 dark:text-gray-300 mb-1">Text Color</label>
        <input
          type="color"
      ...
      {/* Font Style */}
      <div>
        <label className="block text-xs font-medium text-neutral-600 dark:text-gray-300 mb-1">Font Style</label>
