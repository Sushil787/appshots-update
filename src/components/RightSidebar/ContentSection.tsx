...
export const ContentSection = ({
  ...
  <SidebarSection title="Content">
    <div className="space-y-4">
      <div>
        <label className="block text-xs font-medium text-neutral-600 dark:text-gray-300 mb-1">Headline</label>
        <RichTextEditor
      ...
      <div>
        <label className="block text-xs font-medium text-neutral-600 dark:text-gray-300 mb-1">Subheadline</label>
        <RichTextEditor
