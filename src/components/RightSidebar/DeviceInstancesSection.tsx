...
export const DeviceInstancesSection = ({
  ...
  <SidebarSection title="Devices">
    <div className="space-y-2">
      ...
      <p className="text-[11px] leading-4 text-neutral-500 dark:text-gray-400">
      ...
      <div className="space-y-2 mt-3">
        {screenshot.devices.map((device, index) => {
          ...
          return (
            ...
            >
              <div className="w-10 h-10 rounded-lg bg-neutral-100 dark:bg-[#1a1a1a] border border-black/5 dark:border-white/10 flex items-center justify-center">
                <Smartphone className="w-4 h-4 text-neutral-500 dark:text-gray-300" />
              </div>
              <div className="flex-1 min-w-0">
                <p className="text-xs font-medium text-neutral-800 dark:text-gray-200 truncate">{spec.label}</p>
